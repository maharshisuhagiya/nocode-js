    ...
    editors: {
        ...
        stepEditorProvider: (step) => {
            ...
            if (step.type == "replayMessage") {
                ...
                const contentTypeInputLabel = document.createElement('label');
                contentTypeInputLabel.innerText = 'Content Type';
                const contentTypeInputField = document.createElement('input');
                contentTypeInputField.setAttribute('type', 'text');
                contentTypeInputField.placeholder = 'Enter Content Type';
                contentTypeInputField.value = step.properties['contentType'] || '';
                contentTypeInputField.addEventListener('input', () => {
                    step.properties['contentType'] = contentTypeInputField.value;
                });
                editor.appendChild(contentTypeInputLabel);
                editor.appendChild(contentTypeInputField);
                ...
                const payloadInputLabel = document.createElement('label');
                payloadInputLabel.innerText = 'Payload';
                const payloadInputField = document.createElement('input');
                payloadInputField.setAttribute('type', 'text');
                payloadInputField.placeholder = 'Enter Payload';
                payloadInputField.value = step.properties['payload'] || '';
                payloadInputField.addEventListener('input', () => {
                    step.properties['payload'] = payloadInputField.value;
                });
                editor.appendChild(payloadInputLabel);
                editor.appendChild(payloadInputField);
