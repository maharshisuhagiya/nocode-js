    ...
    editors: {
        ...
        stepEditorProvider: (step) => {
            ...
            if (step.type == "replayMessage") {
                ...
                typeInputLabel.innerText = 'Type';
                const typeInputField = document.createElement('input');
                typeInputField.setAttribute('type', 'text');
                typeInputField.placeholder = 'Enter Type';
                typeInputField.value = step.properties['type'] || '';
                typeInputField.addEventListener('input', () => {
                    step.properties['type'] = typeInputField.value;
                });
                editor.appendChild(typeInputLabel);
                editor.appendChild(typeInputField);
