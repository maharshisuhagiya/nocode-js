...
<head>
	...
	<title>📐 Product Replay - Sequential Workflow Designer</title>
	<meta property="og:title" content="📐 Product Replay - Sequential Workflow Designer">
	<meta name="description" content="Product Replay of Sequential Workflow Designer.">
	<meta property="og:description" content="Product Replay of Sequential Workflow Designer.">
...
<body>
	...
	<script src="{{ asset('assets/product-replay.js') }}"></script>
</body>
</html>
